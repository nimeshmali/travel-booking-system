import { BackpackIcon, LogOutIcon, PlusIcon, Trash2Icon } from "lucide-react";
	...
	return (
		<nav className='bg-gradient-to-r from-blue-600 to-purple-700 shadow-md'>
			<div className='container mx-auto px-8 py-4 flex justify-between items-center'>
				<Link to='/' className='text-3xl font-bold text-white hover:text-gray-200 transition duration-300 flex items-center'>
