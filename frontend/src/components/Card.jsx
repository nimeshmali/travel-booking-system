...
const Card = ({ packageData, onBookNow }) => {
	...
	return (
		<UiCard className="group relative w-full max-w-sm mx-auto bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-102 hover:shadow-2xl border-0">
			{/* Image */}
			...
			<CardContent className="p-5 space-y-4">
				...
				<Button
					...
					className="w-full py-3 bg-primary-500 text-white font-semibold rounded-full hover:bg-primary-600 shadow-md transition-colors"
				>
					Book Now
				</Button>
			</CardContent>
